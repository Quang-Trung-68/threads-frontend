...
export default function PostDetailOverlay() {
  ...
  return (
    <div className="bg-background fixed inset-0 z-60 flex min-h-screen w-full flex-col overflow-y-auto">
            ...
            <div className="flex flex-col">
              <div className="px-4 pt-4 pb-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex cursor-pointer items-center">
                    <span className="gap-1 text-gray-400">
                      {t("post:viewActivity")}
                    </span>
                    <span>
              ...
              <div className="flex flex-col px-4 pb-10">
                {repliesData.map((comment) => (
                  <div key={comment.id} className="last:border-0">
                    {/* Separator */}
                    <div className="bg-border my-2 h-px w-full" />
                    <CommentItem {...comment} />
                  </div>
